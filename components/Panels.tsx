  ...
  return (
    <Shell title={t('Bank')} subtitle={t('Gold circulates between the treasury, workers, households and the market.')} onClose={onClose} wide>
      ...
      <p className="muted small">
        ...
        {' '}{t('Attention is yours, not the plot’s: acting on any of your plots keeps every plot you own attended, and each one goes on earning at the shape you left it in.')}
      </p>
        ...
        <div className="connect-card war-card">
          ...
          {war.occupation && (
            <div className="war-status occupied">
              <b>{t('Occupied by {who}', { who: war.occupation.byName || shortAddress(war.occupation.by) })}</b>
              <span className="muted small">
