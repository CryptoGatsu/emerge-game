    ...
    <main className="wiki" lang="zh-CN">
      <div className="wiki-inner">
        ...
        <section id="danger">
          ...
          <h3>作乱的人</h3>
          <p>偶尔会有人与聚落作对：苦闷的、无所寄托的，或与镇上某人结下深仇的。他们举起火把去毁最近的建筑，几小时内建筑就会倒下。<b>你插不了手。</b>你不能把他们提走，也不能提走追他们的人。最近的三名醒着的成年人会放下手头的事去追；有人追到跟前就会扭打，结局是作乱者被关进监狱，或者——最多两次——挣脱后去毁下一栋。已经毁了两栋建筑的人不会被活捉。<b>监狱</b>让作乱的频率减半并关押他们；没有监狱时，用市场地窖。</p>
          <table className="wiki-table">
