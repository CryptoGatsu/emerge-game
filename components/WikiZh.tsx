    ...
    <main className="wiki" lang="zh-CN">
      <div className="wiki-inner">
        ...
        <section id="eras">
          ...
          <h3>每个时代改变了什么</h3>
          <p>自 v2.7 起，时代是一座新城，不只是更长的货架。每栋建筑在每个时代都有自己的<b>形态</b>——自己的名字、样子、容量、产出，产品会变的行当还有自己的配方——地块一推进，<b>所有建筑都重建成下一个形态</b>，<b>同类建筑两两合并为一栋</b>，先合最近的：两间木屋合成一栋联排石屋，床位是两间之和；两座农场合成一座庄园农场，岗位是两座之和。家庭和工人跟着建筑走，每对里第二栋原来的地重新空出来。</p>
          <table className="wiki-table">
