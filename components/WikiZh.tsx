    ...
    <main className="wiki" lang="zh-CN">
      <div className="wiki-inner">
        ...
        <section id="earning">
          ...
          <p><b>质量</b>是这个地方实际的状况——有房（25%）、有饭（25%）、有活（20%）、满足（20%）、安全（10%）。<b>关注</b>是你最近有没有做什么：刚做过就是满值，沉默大约一天半后滑到 {pct(0.08)} 的底线。没人碰的世界只能赚到经营中的世界的一小部分。关注属于<em>你</em>，而不是地块：有两块以上的地时你只能打开一块，所以在任何一块地上做点什么，你名下的每块地都算被照看，没在看的那些按你离开时的样子继续赚取。金库也这样裁定，看的是你在游戏里任何地方的在场。</p>
          <table className="wiki-table">
