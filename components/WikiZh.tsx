...
const STATUS = [
  ['人口', '这里活着的每个人，包括孩子。人们吃饱、有房、满足到愿意成家时它会增长；名声传开时也会：经营得好、有空屋顶的地块吸引路上的移民，咖啡馆、学校、诊所和升级过的房子吸引更多——每天最多三人。严冬或严重的灾害会让它下降。自 v2.7 起，人口以床位和岗位为界：只有在有空床位和空岗位时家庭才会生孩子、新人才会被接纳，孩子也计入两者；成年人多于岗位、或人数多于床位超过五天后，每隔一天左右就会有人上路离开，直到两者相符。最初的八人永远不会离开。',
