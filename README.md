...
OPENSEA_API_KEY=                           # lets /land show what is listed on OpenSea; without it, the game's market alone
OPENSEA_COLLECTION=                        # the collection's slug on OpenSea
OPENSEA_LISTINGS_URL=                      # optional: their endpoint, with {slug} and {chain}
