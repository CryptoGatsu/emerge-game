...
import { ROYALTIES_ADDRESS } from '@/lib/chain/plots';
...
export async function GET(request: Request) {
  ...
  const bps = Number(process.env.NEXT_PUBLIC_EMERGE_ROYALTY_BPS ?? 500);
  return NextResponse.json({
    ...
    external_link: base,
    ...(ROYALTIES_ADDRESS ? { seller_fee_basis_points: bps, fee_recipient: ROYALTIES_ADDRESS } : {}),
