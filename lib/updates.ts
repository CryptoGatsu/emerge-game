...
export const UPDATES: Update[] = [
  {
    ...
    notes: [
      ...
      'Plot expansion: open the outer belt of your plot, about a fifth more ground all the way round, for 500,000 $EMERGE, once per plot.',
...
export const UPDATES_ZH: Update[] = [
  {
    ...
    notes: [
      ...
      '扩建地块：开放地块的外圈，四周约多五分之一的土地，花费 500,000 $EMERGE，每块地一次。',
