...
const KEEP = [
  ...
  'ledgerYesterday', 'stewardship', 'grants', 'clearings', 'wildlife', 'hunt', 'counter', 'expanded', 'era', 'eraSince', 'works', 'charterUntil', 'insuredUntil', 'buildersUntil', 'banner', 'festivalDay', 'gatesClosed', 'keep', 'dug', 'formed', 'restoredForms', 'departures', 'idleDays', 'notables', 'talent', 'exchangeSeen', 'programmes', 'greatWorks',
] as const;
