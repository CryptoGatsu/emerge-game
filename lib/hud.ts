...
import {
  ...
  type WorkingJob, type Job, type World, type Citizen, adviseBuild, latelyOf, traitWords, foodInStore, type Advice, eraGate, eraOf, type EraGate, tradeCapacity, buildingPosts, TRAIN_COST_GOLD, formName, troopCost, troopsAffordable } from './simulation';
import { armyCap, unitOf } from './world/war';import { statusLine } from './speech';
